...
(of EMPLEADO (nombre "Jugador1")(civilizacion caliente)(puntuacion_acumulada 217))
(of EMPLEADO (nombre "Jugador2")(civilizacion secreta)(estado_animo neutral)(positividad_acumulada -1.5)(puntuacion_acumulada 164))
(of EMPLEADO (nombre "Jugador3")(civilizacion secreta)(estado_animo triste)(positividad_acumulada -3.5)(puntuacion_acumulada 247))
)
...
(of PLANETA_FRIO_BUENA (nombre PFB-3)(ofertante "Jugador3"))
(of PLANETA_FRIO_BUENA (nombre PFB-4))
(of PLANETA_FRIO_EXCELENTE (nombre PFE-1)(ofertante "Jugador1"))
(of PLANETA_FRIO_EXCELENTE (nombre PFE-2))
(of PLANETA_FRIO_EXCELENTE (nombre PFE-3))
(of PLANETA_FRIO_EXCELENTE (nombre PFE-4))
(of PLANETA_TEMPLADO_SUFICIENTE (nombre PTS-1)(ofertante "Jugador1"))
(of PLANETA_TEMPLADO_SUFICIENTE (nombre PTS-2)(ofertante "Jugador3"))
...
(posible_civilizacion (empleado "Jugador2")(civilizacion frio)(puntos_creencia_si 0.6)(puntos_creencia_no 1.7))
(posible_civilizacion (empleado "Jugador2")(civilizacion templado)(puntos_creencia_si 1.5)(puntos_creencia_no 0.3))
(posible_civilizacion (empleado "Jugador2")(civilizacion caliente)(puntos_creencia_si 0.3))
(posible_civilizacion (empleado "Jugador3")(civilizacion frio)(puntos_creencia_si 0.75)(puntos_creencia_no 0.5))
(posible_civilizacion (empleado "Jugador3")(civilizacion templado)(puntos_creencia_si 0.4))
(posible_civilizacion (empleado "Jugador3")(civilizacion caliente)(puntos_creencia_no 0.5))
(civilizacion_real (empleado "Jugador2")(civilizacion templado))
(civilizacion_real (empleado "Jugador3")(civilizacion templado))
)