...
(of EMPLEADO (nombre "Jugador2")(civilizacion secreta)(estado_animo neutral)(positividad_acumulada -1.5)(puntuacion_acumulada 195))
(of EMPLEADO (nombre "Jugador3")(civilizacion secreta)(estado_animo neutral)(positividad_acumulada -2.5)(puntuacion_acumulada 247))
)
...
(of PLANETA_CALIENTE_BUENA (nombre PCB-3)(ofertante "Jugador2"))
(of PLANETA_CALIENTE_BUENA (nombre PCB-4))
(of PLANETA_CALIENTE_EXCELENTE (nombre PCE-1))
(of PLANETA_CALIENTE_EXCELENTE (nombre PCE-2)(ofertante "Jugador2"))
...
(of PLANETA_ARTIFICIAL_BUENA (nombre PAB-4)(ofertante "Jugador1"))
...
(posible_civilizacion (empleado "Jugador3")(civilizacion frio)(puntos_creencia_si 1.65)(puntos_creencia_no 1.0))
(posible_civilizacion (empleado "Jugador3")(civilizacion templado)(puntos_creencia_si 0.6)(puntos_creencia_no 0.3))
