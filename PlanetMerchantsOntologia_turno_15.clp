...
(of EMPLEADO (nombre "Jugador2")(civilizacion secreta)(estado_animo triste)(positividad_acumulada -2.5)(puntuacion_acumulada 164))
(of EMPLEADO (nombre "Jugador3")(civilizacion secreta)(estado_animo triste)(positividad_acumulada -3.0)(puntuacion_acumulada 247))
)
...
(of PLANETA_TEMPLADO_SUFICIENTE (nombre PTS-3)(ofertante "Jugador2"))
(of PLANETA_TEMPLADO_SUFICIENTE (nombre PTS-4))
(of PLANETA_TEMPLADO_BUENA (nombre PTB-1))
(of PLANETA_TEMPLADO_BUENA (nombre PTB-2)(ofertante "Jugador1"))
...
(of PLANETA_CALIENTE_BUENA (nombre PCB-3)(ofertante "Jugador3"))
...
(posible_civilizacion (empleado "Jugador2")(civilizacion frio)(puntos_creencia_no 1.0))
(posible_civilizacion (empleado "Jugador2")(civilizacion templado)(puntos_creencia_si 0.8))
