...
(defclass PLANETA (is-a INITIAL-OBJECT)
 ...
 (slot poseedor (type STRING)(default "secreto"))
...
(of EMPLEADO (nombre "Jugador2")(civilizacion secreta)(estado_animo neutral)(puntuacion_acumulada 45))
...
(of PLANETA_FRIO_BUENA (nombre PFB-3)(ofertante "Jugador2"))
...
(of PLANETA_TEMPLADO_SUFICIENTE (nombre PTS-2)(ofertante "Jugador2"))
