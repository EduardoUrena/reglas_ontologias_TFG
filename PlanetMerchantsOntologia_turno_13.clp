...
(of EMPLEADO (nombre "Jugador2")(civilizacion secreta)(estado_animo triste)(positividad_acumulada -2.0)(puntuacion_acumulada 164))
(of EMPLEADO (nombre "Jugador3")(civilizacion secreta)(estado_animo triste)(positividad_acumulada -2.5)(puntuacion_acumulada 173))
)
...
(of PLANETA_FRIO_EXCELENTE (nombre PFE-4)(ofertante "Jugador2"))
...
(of PLANETA_TEMPLADO_EXCELENTE (nombre PTE-3)(ofertante "Jugador1"))
...
(of PLANETA_RECURSOS_POBRE (nombre PRP-2)(ofertante "Jugador3"))
...
(posible_civilizacion (empleado "Jugador2")(civilizacion templado)(puntos_creencia_si 0.2))
(posible_civilizacion (empleado "Jugador2")(civilizacion caliente)(puntos_creencia_si 0.15))
(posible_civilizacion (empleado "Jugador3")(civilizacion frio)(puntos_creencia_no 0.5))
(posible_civilizacion (empleado "Jugador3")(civilizacion templado)(puntos_creencia_si 0.55))
(posible_civilizacion (empleado "Jugador3")(civilizacion caliente)(puntos_creencia_si -0.25))
