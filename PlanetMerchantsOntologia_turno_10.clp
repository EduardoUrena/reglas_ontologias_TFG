...
(of EMPLEADO (nombre "Jugador2")(civilizacion secreta)(estado_animo triste)(positividad_acumulada -1)(puntuacion_acumulada 88))
(of EMPLEADO (nombre "Jugador3")(civilizacion secreta)(estado_animo triste)(positividad_acumulada -1.5)(puntuacion_acumulada 173))
)
...
(of PLANETA_TEMPLADO_SUFICIENTE (nombre PTS-3)(ofertante "Jugador3"))
(of PLANETA_TEMPLADO_SUFICIENTE (nombre PTS-4))
(of PLANETA_TEMPLADO_BUENA (nombre PTB-1)(ofertante "Jugador2"))
...
(of PLANETA_ARTIFICIAL_EXCELENTE (nombre PAE-1)(ofertante "Jugador1"))
...
(posible_civilizacion (empleado "Jugador2")(civilizacion templado)(puntos_creencia_si 0.4)(puntos_creencia_no 0.3))
