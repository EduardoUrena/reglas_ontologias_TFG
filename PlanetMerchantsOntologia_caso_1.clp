...
;Plantilla para que los planetas ofrecidos por el jugador activo y los jugadores no activos no se comprueben mas veces de las necesarias para decidir las 
;cantidades de creencia sobre si los jugadores no activos pueden o no tener una civilizacion.
...
(of PLANETA_FRIO_BUENA (nombre PFB-2)(ofertante "Jugador3"))
...
(of PLANETA_TEMPLADO_SUFICIENTE (nombre PTS-1)(ofertante "Jugador3"))
...
(of PLANETA_RECURSOS_SUFICIENTE (nombre PRS-4)(ofertante "Jugador2"))
