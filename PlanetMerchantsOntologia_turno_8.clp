...
(of EMPLEADO (nombre "Jugador1")(civilizacion caliente)(puntuacion_acumulada 79))
(of EMPLEADO (nombre "Jugador2")(civilizacion secreta)(estado_animo neutral)(positividad_acumulada 0)(puntuacion_acumulada 88))
(of EMPLEADO (nombre "Jugador3")(civilizacion secreta)(estado_animo triste)(positividad_acumulada -1)(puntuacion_acumulada 87))
)

;Instancias de cartas de planeta.
(definstances cartas_planeta
(of PLANETA_FRIO_SUFICIENTE (nombre PFS-1)(ofertante "Jugador2"))
(of PLANETA_FRIO_SUFICIENTE (nombre PFS-2))
(of PLANETA_FRIO_SUFICIENTE (nombre PFS-3))
(of PLANETA_FRIO_SUFICIENTE (nombre PFS-4))
(of PLANETA_FRIO_BUENA (nombre PFB-1)(ofertante "Jugador3"))
(of PLANETA_FRIO_BUENA (nombre PFB-2))
(of PLANETA_FRIO_BUENA (nombre PFB-3))
(of PLANETA_FRIO_BUENA (nombre PFB-4))
(of PLANETA_FRIO_EXCELENTE (nombre PFE-1))
(of PLANETA_FRIO_EXCELENTE (nombre PFE-2))
(of PLANETA_FRIO_EXCELENTE (nombre PFE-3))
(of PLANETA_FRIO_EXCELENTE (nombre PFE-4))
(of PLANETA_TEMPLADO_SUFICIENTE (nombre PTS-1)(ofertante "Jugador2"))
...
(of PLANETA_TEMPLADO_BUENA (nombre PTB-1)(ofertante "Jugador1"))
(of PLANETA_TEMPLADO_BUENA (nombre PTB-2)(ofertante "Jugador3"))
(of PLANETA_TEMPLADO_BUENA (nombre PTB-3))
(of PLANETA_TEMPLADO_BUENA (nombre PTB-4))
(of PLANETA_TEMPLADO_EXCELENTE (nombre PTE-1))
...
(of PLANETA_ARTIFICIAL_BUENA (nombre PAB-2))
(of PLANETA_ARTIFICIAL_BUENA (nombre PAB-3))
(of PLANETA_ARTIFICIAL_BUENA (nombre PAB-4))
(of PLANETA_ARTIFICIAL_EXCELENTE (nombre PAE-1)(ofertante "Jugador2"))
...
(of PLANETA_RECURSOS_SUFICIENTE (nombre PRS-1))
(of PLANETA_RECURSOS_SUFICIENTE (nombre PRS-2))
(of PLANETA_RECURSOS_SUFICIENTE (nombre PRS-3)(ofertante "Jugador1"))
(of PLANETA_RECURSOS_SUFICIENTE (nombre PRS-4)(ofertante "Jugador1"))
...
(posible_civilizacion (empleado "Jugador3")(civilizacion frio)(puntos_creencia_si 0.3))
(posible_civilizacion (empleado "Jugador3")(civilizacion templado)(puntos_creencia_si 0.2))
(posible_civilizacion (empleado "Jugador3")(civilizacion caliente)(puntos_creencia_no 1.0))
(civilizacion_real (empleado "Jugador2")(civilizacion caliente))
(civilizacion_real (empleado "Jugador3")(civilizacion frio))
)